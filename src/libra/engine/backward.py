...
class BackwardInterpreter(Interpreter):
    ...
    def feasibility(self, state, manager, key=None, do=False, chunk=None):
        ...
        for idx, value in enumerate(self.values):
            if isinstance(state, (DeepPolyState, ProductState)):
    ...
    def consumer(self, queue3, entry, manager):
        ...
        while True:
            ...
            for item in one_hot:
                if isinstance(entry, (DeepPolyState, ProductState)):
    ...
    def worker1(self, id, color, queue1, manager):
        ...
        while True:
            ...
            if isinstance(self.initial.precursory, (DeepPolyState, ProductState)):
